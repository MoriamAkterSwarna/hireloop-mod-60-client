...
export default function PostJobPage() {
  ...
  const handleSubmit = (e) => {
    ...
    const payload = {
      ...
      status: "active", // Saves with status active per requirements
        ...
        <div className="border-b border-zinc-800 pb-6 mb-8">
          ...
          <div className="mt-4 inline-flex items-center gap-2 bg-zinc-900/50 border border-zinc-800 rounded-lg px-3 py-1.5 text-xs text-zinc-400">
            ...
            {mockCompany.isApproved ? (
              ...
              <span className="text-amber-500 font-medium bg-amber-950/30 px-1.5 py-0.5 rounded border border-amber-900/50">Pending Approval</span>
            )}
          </div>
        </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <Switch 
                    ...
                    color="default"
                    classNames={{
                      wrapper: "bg-zinc-800 group-data-[selected=true]:bg-white group-data-[selected=true]:text-black",
                      thumb: "bg-zinc-400 group-data-[selected=true]:bg-black"
                    }}
                  >
